 ...
 * Generated at: 2021-12-13 02:17:41 UTC
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <input type=\"button\" value=\"공지사항\" style=\"width: 400px; height: 50px;\" onclick=\"location.href='noticeList.do'\">\r\n");
      out.write("      <input type=\"button\" value=\"Q&A\" style=\"width: 400px; height: 50px; background-color: #ff9797; border: none;\" onclick=\"location.href='qnaList.do'\">\r\n");
      out.write("   </div>\r\n");
      out.write("   <br>\r\n");
      out.write("   <div class=\"dataTbl1\" style=\"height: 300px;\">\r\n");
      out.write("      <table>\r\n");
      out.write("         <!--표의 제목-->\r\n");
      out.write("         <caption>Q & A</caption>\r\n");
      out.write("         <!--테이블 머리말 부분-->\r\n");
      out.write("         <thead>\r\n");
      out.write("            <tr>\r\n");
      out.write("               <th style=\"font-size:20px;color:#ff7d9e;\">Q</th>\r\n");
      ...
      out.write("   </div>\r\n");
      out.write("      <script>\r\n");
      out.write("         function a(no,writer) {\r\n");
      out.write("            let a_no = no;\r\n");
      out.write("            console.log('a_no =' + a_no);\r\n");
      out.write("            console.log('writer = ' + writer);\r\n");
      out.write("            $.ajax ({\r\n");
      out.write("               url : 'qnaAnswer.do?a_no=' + a_no,\r\n");
      out.write("               type : 'post',\r\n");
      out.write("               success : function (data) {\r\n");
      out.write("                  $('.answer').text(\"\");\r\n");
      out.write("                  $('.a_content').text(\"\");\r\n");
      out.write("                  $('.a_writer').text(\"\");\r\n");
      out.write("                  $('.a_writedate').text(\"\");\r\n");
      out.write("                  console.log(data);\r\n");
      out.write("                  if (!data) {\r\n");
      out.write("                     $('#' + no).val(\"\");\r\n");
      out.write("                     $('#' + no).text('A');   \r\n");
      out.write("                     $('#content' + no).text('답변 준비중입니다!');                  \r\n");
      out.write("                  } else {\r\n");
      out.write("                     console.log('옴');\r\n");
      out.write("                     $('#' + no).val(\"\");\r\n");
      out.write("                     $('#' + no).text('A');   \r\n");
      out.write("                     $('#content' + no).text(data.content);\r\n");
      out.write("                     $('#writer' + no).text(data.writer);\r\n");
      out.write("                     $('#writedate' + no).text(data.writedate.substring(0,10));\r\n");
      out.write("                  }\r\n");
      out.write("               }\r\n");
      out.write("            });\r\n");
      out.write("         }\r\n");
      ...
      out.write("         <div style=\"margin-left: 1175px; margin-top: 80px;\">\r\n");
      out.write("           <input type=\"button\" value=\"질문하기\" onclick=\"location.href='qnaWrite.do'\">\r\n");
      out.write("         </div>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/center/qna.jsp(92,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("dto");
      // /WEB-INF/views/center/qna.jsp(92,12) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("</td>\r\n");
            out.write("                  <td class=\"article\"><a href=\"javascript:a(");
            ...
            out.write("                  <td id=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.q_idx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" class=\"answer\" style=\"font-size:20px;color: #ff9797; border: none;\"></td>\r\n");
            out.write("                  <td id=\"content");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.q_idx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" class=\"a_content\" style=\"border: none;\"></td>\r\n");
            out.write("                  <td id=\"writer");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.q_idx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" class=\"a_writer\" style=\"border: none;\"></td>\r\n");
            out.write("                  <td id=\"writedate");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.q_idx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" class=\"a_writedate\" style=\"border: none;\"></td>\r\n");
            out.write("               </tr>\r\n");
            out.write("            ");
